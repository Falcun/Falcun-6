...
public final class FalcunGuiManager {
	...
	public static final FalcunGuiManager instance = new FalcunGuiManager();
	private static final FalcunMainMenu mainMenu = new FalcunMainMenu();
	private static final FalcunInGameMenu modMenu = new FalcunInGameMenu();
...
//		Falcun.minecraft.displayGuiScreen(new GuiMod);
	...
	public void tick(TickEvent.ClientTickEvent e) {
		if (Falcun.minecraft.theWorld == null && Falcun.minecraft.currentScreen instanceof GuiMainMenu) {
			openMainMenu();
		}
	}
