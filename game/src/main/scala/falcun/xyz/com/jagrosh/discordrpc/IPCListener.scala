...
trait IPCListener {
   ...
   */
  def onPacketSent(client: IPCClient, packet: Packet): Unit = {
  }
   ...
   */
  def onPacketReceived(client: IPCClient, packet: Packet): Unit = {
  }
   ...
   */
  def onActivityJoin(client: IPCClient, secret: String): Unit = {
  }
   ...
   * @param secret The secret of the event, determined by the implementation and specified by the user.
   */
  def onActivitySpectate(client: IPCClient, secret: String): Unit = {
  }
   ...
   */
  def onActivityJoinRequest(client: IPCClient, secret: String, user: User): Unit = {
  }
   ...
   */
  def onReady(client: IPCClient): Unit = {
  }
   ...
   */
  def onClose(client: IPCClient, json: JSONObject): Unit = {
  }
   ...
   */
  def onDisconnect(client: IPCClient, t: Throwable): Unit = {
  }
}