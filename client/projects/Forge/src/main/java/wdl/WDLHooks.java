...
public class WDLHooks {
	...
	public static void injectWDLButtons(GuiIngameMenu gui, List buttonList) {
		int insertAtYPos = gui.height - 20;
...
//		}
		...
		// Insert wdl buttons.
		GuiButton wdlDownload = new GuiButton(WDLs, gui.width- 148,
				insertAtYPos,120, 20, null);
		
		GuiButton wdlOptions = new GuiButton(WDLo, gui.width-28,
				insertAtYPos, 28, 20,
