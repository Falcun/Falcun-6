...
public class ConfigurationHandler {
    ...
    public static final String SCHEMATIC_DIRECTORY_STR = Paths.get(System.getenv("APPDATA") == null ? System.getProperty("user.home") : System.getenv("APPDATA"), ".falcun", "schematics").toString();
    ...
    public static int redBlocks = 0;
    public static int orangeBlocks = 0;
    public static int purpleBlocks = 0;
    ...
    private static void loadConfigurationRender() {
        ...
        highlightAir = net.mattbenson.modules.types.mods.Schematica.higlightAir;
        highlight = net.mattbenson.modules.types.mods.Schematica.higlight;
        renderDistance = net.mattbenson.modules.types.mods.Schematica.renderDistance;
    }
    ...
    private static void loadConfigurationPrinter() {
        ...
        placeDelay = net.mattbenson.modules.types.mods.Schematica.placeDelay;
    	timeout = net.mattbenson.modules.types.mods.Schematica.timeout;
    	placeDistance = net.mattbenson.modules.types.mods.Schematica.placeDistance;
    	placeInstantly = net.mattbenson.modules.types.mods.Schematica.placeInstantly;
    	destroyBlocks = net.mattbenson.modules.types.mods.Schematica.destryBlocks;
    	destroyInstantly = net.mattbenson.modules.types.mods.Schematica.destryBlocksInstantly;
    	placeAdjacent = net.mattbenson.modules.types.mods.Schematica.placeAdjacent;
    }
    ...
    private static void loadConfigurationSwapSlots() {
        ...
        for (int i = 0; i < SWAP_SLOTS_DEFAULT.length; i++) {
        	...
        	swapSlots[0]= net.mattbenson.modules.types.mods.Schematica.slot1;
        	swapSlots[1]= net.mattbenson.modules.types.mods.Schematica.slot2;
        	swapSlots[2]= net.mattbenson.modules.types.mods.Schematica.slot3;
        	swapSlots[3]= net.mattbenson.modules.types.mods.Schematica.slot4;
        	swapSlots[4]= net.mattbenson.modules.types.mods.Schematica.slot5;
        	swapSlots[5]= net.mattbenson.modules.types.mods.Schematica.slot6;
        	swapSlots[6]= net.mattbenson.modules.types.mods.Schematica.slot7;
        	swapSlots[7]= net.mattbenson.modules.types.mods.Schematica.slot8;
        	swapSlots[8]= net.mattbenson.modules.types.mods.Schematica.slot9;
            if (swapSlots[i]) {
    ...
    private static void loadConfigurationGeneral() {
        ...
        schematicDirectory = Paths.get(Minecraft.getMinecraft().mcDataDir.getAbsolutePath(), "schematics").toFile();
