...
public class PlacementRegistry {
    ...
    private void populateMappings() {
        ...
        addPlacementMapping(Blocks.standing_banner, new PlacementData(playerFacingStandingSign));
        ...
        addPlacementMapping(Blocks.wall_banner, new PlacementData(blockFacingOpposite));
