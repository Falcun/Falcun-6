...
public class KickUpsEmote extends Emote
{
    public KickUpsEmote(String name, int duration, boolean looping, ResourceLocation sound, ResourceLocation location)
    {
    ...
    {
        animator.userConfig.meshes.get("ball").visible = true;
    }
    ...
    {
        animator.userConfig.meshes.get("ball").visible = false;
    }
}