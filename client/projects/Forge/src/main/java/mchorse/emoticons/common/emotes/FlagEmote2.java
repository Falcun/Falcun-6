...
public class FlagEmote2 extends Emote
{
    public FlagEmote2(String name, int duration, boolean looping, ResourceLocation sound, ResourceLocation location)
    {
    ...
    {
        animator.userConfig.meshes.get("flag2").visible = true;
    ...
    {
        animator.userConfig.meshes.get("flag2").visible = false;
