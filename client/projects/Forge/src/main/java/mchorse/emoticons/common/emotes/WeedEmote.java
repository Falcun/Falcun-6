...
public class WeedEmote extends Emote
{
    public WeedEmote(String name, int duration, boolean looping, ResourceLocation sound, ResourceLocation location)
    {
    ...
    {
        animator.userConfig.meshes.get("smoke").visible = true;
    }
    ...
    {
        animator.userConfig.meshes.get("smoke").visible = false;
    }
}