...
public class FlagEmote5 extends Emote
{
    public FlagEmote5(String name, int duration, boolean looping, ResourceLocation sound, ResourceLocation location)
    {
    ...
    {
        animator.userConfig.meshes.get("flag5").visible = true;
    ...
    {
        animator.userConfig.meshes.get("flag5").visible = false;
