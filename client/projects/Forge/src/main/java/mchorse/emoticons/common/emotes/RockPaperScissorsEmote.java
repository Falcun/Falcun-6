...
public class RockPaperScissorsEmote extends Emote
{
    ...
    public RockPaperScissorsEmote(String name, int duration, boolean looping)
    {
        super(name, duration, looping);
    }

    public RockPaperScissorsEmote(String name, int duration, boolean looping, String suffix)
    {
        super(name, duration, looping);
        this.suffix = suffix;
    }
    ...
    {
        return new RockPaperScissorsEmote(this.name, this.duration, this.looping, suffix);
    }
