...
import mchorse.emoticons.utils.MatrixUtils;
...
public class AnimatorController
{
     ...
     */
    public static final IAnimatorFactory DEFAULT_FACTORY = new IAnimatorFactory() {
		@Override
    ...
    public Vector4f calcPosition(EntityLivingBase entity, BOBJBone bone, float x, float y, float z, float partial)
    {
        ...
        this.rotate.rotY((180 - entity.renderYawOffset + 180) / 180F * pi);
    ...
    public void renderOnScreen(EntityPlayer player, int x, int y, float scale, float alpha)
    {
        ...
        if (this.animation != null && this.animation.meshes.size() > 0)
        {
            ...
            /* Head looks ugly without reseting those fields */
    ...
    public void renderAnimation(EntityLivingBase entity, AnimationMesh mesh, float yaw, float partialTicks)
    {
        ...
        {
            alpha = !entity.isInvisibleToPlayer(Minecraft.getMinecraft().thePlayer) ? 0.15F : 0;
        }
    ...
    public void renderItem(EntityLivingBase entity, ItemStack stack, BOBJArmature armature, AnimatorHeldItemConfig itemConfig, TransformType type, float scale)
    {
        ...
        if (bone != null)
        {
            ...
            GlStateManager.translate(0, -1 / 16F, 1 / 16F);
            GlStateManager.scale(scale * itemConfig.scaleX, scale * itemConfig.scaleY, scale * itemConfig.scaleZ);
