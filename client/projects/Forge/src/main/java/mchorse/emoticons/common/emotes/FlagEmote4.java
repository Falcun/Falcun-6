...
public class FlagEmote4 extends Emote
{
    public FlagEmote4(String name, int duration, boolean looping, ResourceLocation sound, ResourceLocation location)
    {
    ...
    {
        animator.userConfig.meshes.get("flag4").visible = true;
    ...
    {
        animator.userConfig.meshes.get("flag4").visible = false;
