...
public abstract class Entity implements ICommandSender, net.minecraftforge.common.capabilities.ICapabilitySerializable<NBTTagCompound> {
	...
	public boolean cachedEntity  = false;
	...
	public Entity(World worldIn) {
		...
		for (net.minecraftforge.common.IExtendedEntityProperties props : extendedProperties.values())
	...
	public boolean checkEquality(Entity entity) {
		return this.posX == entity.posX && this.posY == entity.posY && this.posZ == entity.posZ && this.motionX == entity.motionX && this.motionY == entity.motionY && this.motionZ == entity.motionZ;
	}
	...
	public void readFromNBT(NBTTagCompound tagCompund) {
		try {
			...
			if (this.capabilities != null && tagCompund.hasKey("ForgeCaps"))
				this.capabilities.deserializeNBT(tagCompund.getCompoundTag("ForgeCaps"));
	...
	public void mountEntity(Entity entityIn) {
		if (!(this instanceof EntityLivingBase) && !net.minecraftforge.event.ForgeEventFactory.canMountEntity(this, entityIn, true)) {
			return;
		}
