...
public abstract class Entity implements ICommandSender, net.minecraftforge.common.capabilities.ICapabilitySerializable<NBTTagCompound>
{
    ...
    public Entity(World worldIn)
    {
        ...
        Wrapper.getInstance().post(new EntityCreateEvent(this, worldIn));
    }
    ...
    //MATT NEW FPS
    public boolean hasCapability(final Capability<?> capability, final EnumFacing direction) {
        return this.capabilities != null && this.capabilities.hasCapability((Capability)capability, direction);
    }
