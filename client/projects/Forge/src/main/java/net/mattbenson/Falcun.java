...
public class Falcun {
	...
	private void postInit() {
		...
		rpc = new DiscordRPC(677592205015121940L);
		rpc.loadRPC();
...
//		}
		...
		try {
			...
			printStatus("ABOUT TO CHECK EMAIL");

			email = URLEncoder.encode(email, "UTF-8");
			printStatus("EMAIL ENCODED");
			hwid = URLEncoder.encode(hwid, "UTF-8");
printStatus("HWID ENCODED");
...
printStatus("WEBREQUEST CONNECTED");
...
//			}
		...
		printStatus("ABOUT TO POST INIT");
