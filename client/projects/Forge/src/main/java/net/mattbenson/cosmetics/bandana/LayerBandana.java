...
public class LayerBandana implements LayerRenderer<AbstractClientPlayer> {
	...
	public void doRenderLayer(AbstractClientPlayer entitylivingbaseIn, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale) {
		...
		if(ANIMATED_BUN) {
			Falcun.getInstance().bandanaManager.getBandanaRenderer().applyAnimation(entitylivingbaseIn);
			Falcun.getInstance().bandanaManager.getBandanaRenderer().render(0.0625F);
		} else {
