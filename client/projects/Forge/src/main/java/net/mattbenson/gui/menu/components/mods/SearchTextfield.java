...
public class SearchTextfield extends MenuTextField {
	...
	public void onRender() {
		...
		if(drawPointer) {
			...
			drawVerticalLine(x + 10 + (int)Fonts.RobotoItalic.getStringWidth(textToDraw.substring(0, toRender)) + 1, y + height / 2 - textHeight / 2, textHeight, 1, textColor);
		}
		...
		Fonts.RobotoItalic.drawString(textToDraw, x + 10 + minOffset + xAdd, y + height / 2 - (int)Fonts.RobotoItalic.getStringHeight(textToDraw) / 2, textColor);
