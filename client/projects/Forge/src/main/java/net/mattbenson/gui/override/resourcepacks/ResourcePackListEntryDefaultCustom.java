...
public class ResourcePackListEntryDefaultCustom extends ResourcePackListEntryCustom
{
    private static final Logger logger = LogManager.getLogger();
    private final IResourcePack field_148320_d;
    private final ResourceLocation resourcePackIcon;

    public ResourcePackListEntryDefaultCustom(GuiScreenResourcePacksCustom resourcePacksGUIIn)
    {
