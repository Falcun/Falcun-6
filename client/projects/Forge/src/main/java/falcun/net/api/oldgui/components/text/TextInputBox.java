package falcun.net.api.oldgui.components.text;
...
import falcun.net.api.oldgui.components.shape.CurvedShape;
import falcun.net.api.oldgui.components.shape.CurvedShapeOutline;
import falcun.net.api.oldgui.effects.Effect;
import falcun.net.api.oldgui.effects.OnHoverEffect;
import falcun.net.api.oldgui.effects.ScissorEffect;
