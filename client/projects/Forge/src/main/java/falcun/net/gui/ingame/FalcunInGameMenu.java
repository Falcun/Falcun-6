...
import falcun.net.api.gui.components.texture.TextureSquareOpeningAnimated;
import falcun.net.api.gui.effects.EnterExitEffect;
import falcun.net.api.gui.effects.OnClickEffect;
import falcun.net.api.gui.menu.FalcunEmptyPage;
...
import falcun.net.gui.ingame.cosmetics.FalcunCosmeticsPage;
import falcun.net.gui.ingame.fps.FalcunFPSPage;
import falcun.net.gui.ingame.groups.FalcunGroupsPage;
import falcun.net.gui.ingame.hud.FalcunHUDPage;
...
import static falcun.net.gui.ingame.FalcunInGameMenu.Page.*;
