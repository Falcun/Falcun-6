...
public class Auth {
    ...
    public static void checkGameOwnership(String accessToken) throws AuthException, IllegalArgumentException, Exception {
        ...
        if (IAS.GSON.fromJson(pr.body(), JsonObject.class).getAsJsonArray("items").size() == 0) throw new AuthException(new ChatComponentTranslation("ias.msauth.error.gamenotowned"));
    }
