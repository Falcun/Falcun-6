package falcun.xyz.accswitcher.the_fireplace.ias;

import java.util.List;

import falcun.xyz.accswitcher.the_fireplace.ias.gui.GuiAccountSelector;
import falcun.xyz.accswitcher.the_fireplace.ias.gui.GuiButtonWithImage;
...
import falcun.xyz.accswitcher.ru.vidtu.ias.utils.Converter;
import falcun.xyz.accswitcher.ru.vidtu.ias.utils.Expression;
import falcun.xyz.accswitcher.ru.vidtu.ias.utils.SkinRenderer;

/**
 * @author The_Fireplace
 */
@Mod(modid = "ias", clientSideOnly = true, guiFactory = "IASGuiFactory")
public class IAS {
