...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    {
    	if (!Wrapper.getInstance().post(new RenderEntityEvent(entity, this, x, y, z))) {
    		return;
    	}
    ...
    public void renderName(T entity, double x, double y, double z)
    {
        ...
        {
        	if (this.canRenderName(entity) || (Wrapper.getInstance().isF5Nametags() && entity instanceof EntityPlayer && entity == Minecraft.getMinecraft().thePlayer))
            {
