...
public abstract class GuiResourcePackListCustom extends GuiListExtended
{
    protected final Minecraft mc;
    protected final List<ResourcePackListEntryCustom> field_148204_l;

    public GuiResourcePackListCustom(Minecraft mcIn, int p_i45055_2_, int p_i45055_3_, List<ResourcePackListEntryCustom> p_i45055_4_)
    {
    ...
    public List<ResourcePackListEntryCustom> getList()
    {
     ...
     */
    public ResourcePackListEntryCustom getListEntry(int index)
    {
        return (ResourcePackListEntryCustom)this.getList().get(index);
    }
