...
public abstract class ResourcePackListEntryCustom implements GuiListExtended.IGuiListEntry
{
    ...
    protected final GuiScreenResourcePacksCustom resourcePacksGUI;

    public ResourcePackListEntryCustom(GuiScreenResourcePacksCustom resourcePacksGUIIn)
    {
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
    {
        ...
        if ((this.mc.gameSettings.touchscreen || isSelected) && this.func_148310_d())
        {
            ...
            List<ResourcePackListEntryCustom> list = this.resourcePacksGUI.getListContaining(this);
            int mod = 1;
    ...
    protected boolean func_148314_g()
    {
        ...
        return i > 0 && ((ResourcePackListEntryCustom)list.get(i - 1)).func_148310_d();
    }
    ...
    protected boolean func_148307_h()
    {
        List<ResourcePackListEntryCustom> list = this.resourcePacksGUI.getListContaining(this);
        int i = list.indexOf(this);
        return i >= 0 && i < list.size() - 1 && ((ResourcePackListEntryCustom)list.get(i + 1)).func_148310_d();
    }
    ...
    public boolean mousePressed(int slotIndex, int p_148278_2_, int p_148278_3_, int p_148278_4_, int p_148278_5_, int p_148278_6_)
    {
        if (this.func_148310_d())
        {
            if (this.func_148309_e())
            {
                ...
                if (p_148278_5_ < 32 && p_148278_5_ > 16)
                {
                    ...
                    this.mc.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback()
                    {
                        ...
                        {
                            List<ResourcePackListEntryCustom> list2 = ResourcePackListEntryCustom.this.resourcePacksGUI.getListContaining(ResourcePackListEntryCustom.this);
                            ResourcePackListEntryCustom.this.mc.displayGuiScreen(ResourcePackListEntryCustom.this.resourcePacksGUI);

                            if (result)
                            {
                                list2.remove(ResourcePackListEntryCustom.this);
                                ResourcePackListEntryCustom.this.resourcePacksGUI.getSelectedResourcePacks().add(0, ResourcePackListEntryCustom.this);
                            }
                        }
                    }, s1, s, 0));
                }
            ...
            if (p_148278_5_ < 32 && p_148278_5_ > 16 && this.func_148308_f())
            {
            ...
            {
                List<ResourcePackListEntryCustom> list1 = this.resourcePacksGUI.getListContaining(this);
