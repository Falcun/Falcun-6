...
public class ModsPage extends Page {
	...
	private void initModPage(ModScrollPane pane) {
		...
		for(Module module : Falcun.getInstance().moduleManager.getModules().stream().filter(entry ->
			...
			if (module.getName().equals("Image1")) return;
			if (module.getName().equals("Image2")) return;
			if (module.getName().equals("Image3")) return;
			if (module.getName().equals("Image4")) return;
			if (module.getName().equals("Image5")) return;
			if (module.getName().equals("Text1")) return;
			if (module.getName().equals("Text2")) return;
			if (module.getName().equals("Text3")) return;
			if (module.getName().equals("Text4")) return;
			if (module.getName().equals("Text5")) return;
