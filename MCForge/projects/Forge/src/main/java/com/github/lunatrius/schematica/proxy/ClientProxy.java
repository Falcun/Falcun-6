...
public class ClientProxy extends CommonProxy {
    ...
    public static void moveSchematicToPlayer(final SchematicWorld schematic) {
        if (schematic != null) {
            ...
            net.mattbenson.modules.types.mods.Schematica.x = position.x;
            net.mattbenson.modules.types.mods.Schematica.y = position.y;
            net.mattbenson.modules.types.mods.Schematica.z = position.z;
    ...
    public void init(final FMLInitializationEvent event) {
        ...
        ClientCommandHandler.instance.registerCommand(new CommandSchematicaLoad());
    }
    ...
    public void unloadSchematic() {
    	SchematicPrinter.placedBlocks.clear();
        schematic = null;
    ...
    public boolean loadSchematic(final EntityPlayer player, final File directory, final String filename) {
        ...
        ClientProxy.loadedFile = SchematicFormat.readFile(directory, filename);
        
        if (schematic == null || ClientProxy.loadedFile == null) {
            return false;
        }
