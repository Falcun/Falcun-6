...
public class FlagEmote1 extends Emote
{
    public FlagEmote1(String name, int duration, boolean looping, ResourceLocation sound, ResourceLocation location)
    {
    ...
    {
        animator.userConfig.meshes.get("flag1").visible = true;
    ...
    {
        animator.userConfig.meshes.get("flag1").visible = false;
