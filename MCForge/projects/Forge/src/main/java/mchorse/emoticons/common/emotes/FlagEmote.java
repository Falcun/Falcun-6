...
public class FlagEmote extends Emote
{
    public FlagEmote(String name, int duration, boolean looping, ResourceLocation sound, ResourceLocation location)
    {
    ...
    {
        animator.userConfig.meshes.get("flag").visible = true;
    ...
    {
        animator.userConfig.meshes.get("flag").visible = false;
