...
public class MwGuiMarkerDialog extends MwGuiTextDialog {
	...
	public MwGuiMarkerDialog(GuiScreen parentScreen,
			...
			int x, int y, int z, int dimension, String markerServer) {
		super(parentScreen, I18n.format("mw.gui.mwguimarkerdialog.title.new")
				+ ":", markerName, I18n
				.format("mw.gui.mwguimarkerdialog.error"));
	...
	public boolean submit() {
		...
		case 0:
			...
			if (this.inputValid) {
				this.title = I18n
						.format("mw.gui.mwguimarkerdialog.title.group") + ":";
				this.setText(this.markerGroup);
				this.error = I18n
						.format("mw.gui.mwguimarkerdialog.error.group");
				this.state++;
			}
			break;
		case 1:
		...
		case 4:
			...
			if (this.inputValid) {
				...
				this.markerManager.addMarker(this.markerName, this.markerGroup,
						...
						this.dimension, colour, this.markerServer);
