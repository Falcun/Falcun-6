...
public class MapView {
	...
	public int setZoomLevel(int zoomLevel) {
		...
		if (this.undergroundMode) {
			...
			this.zoomLevel = Math.min(Math.max(this.minZoom, zoomLevel),
					this.maxZoom);
		}
	...
	private void updateZoom() {
		...
		if (MwAPI.getCurrentDataProvider() != null) {
			MwAPI.getCurrentDataProvider().onZoomChanged(this.getZoomLevel(),
					this);
		}
	}
	...
	public void setDimension(int dimension) {
		...
		if (MwAPI.getCurrentDataProvider() != null) {
			MwAPI.getCurrentDataProvider().onDimensionChanged(this.dimension,
					this);
		}
	}
